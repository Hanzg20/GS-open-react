        ...
        <div className="rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 p-8 lg:p-12">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-yellow-100">
              Join leading enterprises leveraging GoldSky's unified platform to drive innovation,
              efficiency, and growth across their operations.
            </p>
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="mt-1 text-sm text-yellow-100">Years of Engineering Excellence</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white">3</div>
                <div className="mt-1 text-sm text-yellow-100">Industry Verticals</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white">∞</div>
                <div className="mt-1 text-sm text-yellow-100">Scalability Potential</div>
              </div>
            </div>
          </div>
        </div>
